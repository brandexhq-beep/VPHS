...
const team = [
  { name: "Amar Narayan", role: "Principal", bio: "With over 20 years of experience in education, Mr. Narayan leads Vignan with a vision for academic excellence and holistic development.", initials: "AN" },
  { name: "Mrs. Lakshmi Devi", role: "Vice Principal", bio: "A dedicated educator focused on curriculum development and student welfare programs.", initials: "LD" },
  { name: "Mr. Ramesh Kumar", role: "Academic Coordinator", bio: "Oversees academic planning and ensures quality teaching standards across all grades.", initials: "RK" },
  { name: "Mrs. Sunita Rao", role: "Administrative Head", bio: "Manages school operations and parent communications with efficiency and warmth.", initials: "SR" },
  { name: "Mr. Venkatesh", role: "Sports Director", bio: "Promotes physical fitness and competitive sports among students.", initials: "V" },
  { name: "Mrs. Priya Sharma", role: "Student Counselor", bio: "Provides guidance and emotional support to students for their overall well-being.", initials: "PS" },
];
          ...
          {team.map((member, i) => (
            ...
            >
              <div className="aspect-[4/3] bg-gradient-to-br from-primary/5 to-accent/5 flex items-center justify-center overflow-hidden relative">
                ...
                >
                  <span className="text-2xl font-heading font-bold text-primary/50">{member.initials}</span>
                </motion.div>
              </div>
              <div className="p-5">
